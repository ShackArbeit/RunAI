...
function FeatureCard({
  ...
  return (
    <article className="group surface-card rounded-[26px] p-6 transition-transform duration-300 hover:-translate-y-2 sm:p-7">
      <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[var(--accent-soft)] text-xl text-[var(--accent)] transition-transform duration-300 group-hover:scale-105">
        {icon}
      </div>
      <h3 className="mt-5 text-2xl font-semibold text-[var(--text-primary)]">{title}</h3>
...
export function FeatureSection() {
  ...
  return (
    <SectionShell id="features" className="py-20 sm:py-24 lg:py-28">
